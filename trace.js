...
(async () => {
  ...
  page.on('request', request => {
    ...
    if (url.includes('api') || url.includes('json') || url.includes('m3u8') || url.includes('.ts') || url.includes('source')) {
  ...
  page.on('response', async response => {
    ...
    if (url.includes('api') || url.includes('source') || url.includes('.json')) {
