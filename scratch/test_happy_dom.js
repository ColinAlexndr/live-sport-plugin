...
async function main() {
  ...
  // Intercept fetch to see if it requests the stream configuration from an API
  ...
  // Mock jwplayer to intercept setup
  ...
  // Aclib (the ad network) complains if runPop is missing
  window.aclib = { runPop: () => {} };

  const document = window.document;
  document.write(fs.readFileSync('scratch/bintv_embed_with_gid.html', 'utf8'));
